<template>
  <div class="min-h-screen">
            ...
            <template #default="{ item: article, index, active }">
              ...
              >
                ...
                >
                  ...
                  <div v-else class="flex h-40 w-full items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800">
    ...
    <!-- 底部备案信息 -->
    <footer class="flex flex-col gap-1 py-6 text-xs text-gray-400 md:flex-row md:items-center md:justify-between dark:text-gray-500">
      <a
