  ...
  <div class="flex min-h-screen items-center justify-center bg-gray-50 px-4 transition-colors dark:bg-gray-900">
    <div class="w-full max-w-sm">
      ...
      <div class="mb-8 text-center">
        <NuxtLink to="/articles" class="inline-block">
      ...
      <div class="mt-6 text-center">
        <NuxtLink to="/articles" class="text-sm text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300">
          ← 返回首页
        </NuxtLink>
      </div>
    </div>
...
async function handleLogin() {
  ...
  try {
    ...
    const redirectTo = (route.query.redirect as string) || '/articles'
