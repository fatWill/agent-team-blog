...
{ name: '餐厅桌椅', budget: 2500, actual: 3596, remark: null },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '洗衣机', budget: 5000, actual: 7200, remark: null },
      { name: '冰箱', budget: 6500, actual: 5699, remark: null },
      { name: '洗碗机', budget: 8000, actual: 7500, remark: null },
      { name: '直饮机', budget: 8000, actual: 7800, remark: null },
      { name: '零冷水', budget: 1000, actual: 0, remark: '回流泵' },
      { name: '全屋净水', budget: 2000, actual: 0, remark: '大白瓶' },
      { name: '扫地机', budget: 5500, actual: 4200, remark: null },
